...
const getClasses = (isRTL) => ({
  wrapper: `mt-16 blog-content ${isRTL ? 'font-hebrew' : 'font-lora'} animate-fade-in-up text-text-dark`,
  title: `mt-16 text-4xl text-terracotta font-bold ${isRTL ? 'font-hebrew' : 'font-lora'} animate-slide-in-left`,
  date: `text-sage font-light ${isRTL ? 'font-hebrew' : 'font-lora'}`,
  ...
  navLink: `flex items-center space-x-2 text-sage hover:text-terracotta transition-colors ${isRTL ? 'font-hebrew' : 'font-lora'}`,
  navLinkRTL: `flex items-center space-x-reverse space-x-2 text-sage hover:text-terracotta transition-colors ${isRTL ? 'font-hebrew' : 'font-lora'}`,
  navText: 'text-sm',
...
const BlogPost = ({ data }) => {
  ...
  const classes = getClasses(isRTL);
