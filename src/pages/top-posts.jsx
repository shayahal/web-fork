...
const TopPostsPage = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      />
      <div className="mt-16 max-w-4xl mx-auto px-4 font-huninn">
        <h1 className="text-4xl font-bold text-terracotta mb-6 font-lora">Top Posts</h1>
        ...
        {posts.length > 0 ? (
          ...
          <p className="text-text-dark font-huninn">No top posts found yet.</p>
        )}
      </div>
    </Layout>
  );
