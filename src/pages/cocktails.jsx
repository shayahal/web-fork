  ...
  return (
    <Layout>
      ...
      <div className="mt-16 max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-gray-900 mb-6 animate-fade-in-up">Cocktails</h1>
        ...
        {posts.length > 0 ? (
          ...
          <p className="text-gray-600 animate-fade-in">No cocktail posts found yet.</p>
        )}
      </div>
    </Layout>
  );
