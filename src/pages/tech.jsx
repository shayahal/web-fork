  ...
  return (
    <Layout>
      ...
      <div className="mt-16 max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-terracotta mb-6 font-play">Tech</h1>
        <p className="text-lg text-sage mb-4 font-lora">
          Posts about technology, security, and building products.
        </p>
        ...
        {posts.length > 0 ? (
          ...
          <p className="text-text-dark font-lora">No tech posts found yet.</p>
        )}
      </div>
    </Layout>
  );
