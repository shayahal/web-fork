        ...
        <div className="prose prose-lg max-w-none font-huninn">
          ...
          <div className="mt-8">
            <a
              ...
              className="inline-block px-6 py-3 bg-sage text-cream rounded-lg font-medium hover:bg-terracotta transition-colors font-huninn"
            >
              לקריאת הכתבה ←
            </a>
          </div>
